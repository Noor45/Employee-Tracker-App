...
class ManagerForgetPasswordScreen extends StatefulWidget {
  static const String ID = "m_forget_password_screen";

  const ManagerForgetPasswordScreen({super.key});
  @override
  _SignInScreenState createState() => _SignInScreenState();
}

class _SignInScreenState extends State<ManagerForgetPasswordScreen> {
