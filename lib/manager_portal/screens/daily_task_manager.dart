...
class ManagerDailyTaskScreen extends StatefulWidget {
  static String ID = "/manager_daily_task_screen";
  const ManagerDailyTaskScreen({super.key});

  @override
  State<ManagerDailyTaskScreen> createState() => _ApplyLeaveState();
}

class _ApplyLeaveState extends State<ManagerDailyTaskScreen> {
