...
class TeamAttendanceScreen extends StatefulWidget {
  ...
  const TeamAttendanceScreen({this.employeeId, super.key});
...
class _TeamAttendanceScreenState extends State<TeamAttendanceScreen> {
  ...
  Future fetchPost() async {
    var URL = Uri.https('localhost', 'api/manager/employee/attendance/"${widget.employeeId}"');
  ...
  ListView buildAttendanceListView(List<AttendanceModel>? attendance) {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        String formattedDate = DateFormat('dd E').format(dateTime);
