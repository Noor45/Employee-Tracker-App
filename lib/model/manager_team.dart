...
class ManagerTeamModel {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      EmployeeModelFields.WORKING_HOURS: workingHours,
    };
  }

  ManagerTeamModel.fromMap(Map<String, dynamic> map) {
    ...
    workingHours = map[EmployeeModelFields.WORKING_HOURS];
  }

  @override
  String toString() {
    return 'EmployeeModel{id: $id, departmentId: $departmentId, managerId: $managerId, name: $name, email: $email, password: $password, image: $image, status: $status, joinDate: $joinDate, endDate: $endDate, recoverPasswordOpt: $recoverPasswordOpt, company_token: $companyToken, working_hours: $workingHours}';
  }
}
