...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    setState(() {
      nameController.text = Constants.employeeDetail!.name!;
      dateController.text = Constants.employeeDetail!.joinDate!;
      employeeController.text = Constants.employeeManagerDetail!.name!;
      departmentController.text = Constants.employeeDepartment!.name!;
    });
  }
  ...
  Widget build(BuildContext context) {
    print(Constants.employeeDetail);
          ...
          child: Center(
            child: Column(
              children: [
                      ...
                      children: [
                        Container(
                          ...
                          child:
                              ...
                              //       )
                              // :
                              Constants.employeeDetail?.image != null &&
                                      Constants
                                              .employeeDetail?.image!.isEmpty ==
                                          false
                                  ? ClipRRect(
                                      borderRadius: BorderRadius.circular(65),
                                      child: FadeInImage.assetNetwork(
                                        image:
                                            '${StringRefer.imagesPath}${Constants.employeeDetail?.image as String}',
                                        fit: BoxFit.cover,
                ...
                TextButton(
                  onPressed: () {},
                  child: Text(Constants.employeeDetail!.email!,
                      style: TextStyle(
