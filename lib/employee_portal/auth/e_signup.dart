...
class _EmployeeSignUPScreenState extends State<EmployeeSignUPScreen> {
  ...
  Future<void> _registerUser() async {
    ...
    if (_password != _confirmPassword) {
      ...
      if (image != null) {
        print(selectCompany);
        final response = await NetworkUtil.internal().registerEmployeeWithImage(
        ...
        final response =
            await NetworkUtil.internal().post('/api/employee/register', body: {
          'name': _name,
          'email': _email,
          'password': _password,
        ...
        print(response.body);
        print('response.bodyyyyyyyyyyyy');
